...
class test_set_weapon_name(unittest.TestCase):
    ...
    def test_weapon_name_is_set(self):
        ...
        self.assertEqual(categorize.get_weapon_name(source_text=pass_json, id=4),'Crystaring')

    def test_weapon_name_does_not_have_modifier(self):
        toan_json = categorize.get_json(toan_screen_path)
        self.assertEqual(categorize.get_weapon_name(source_text=toan_json, id=4),'Choora')
...
class test_determine_character_name(unittest.TestCase):
    ...
    def test_choora_belongs_to_toan(self):
        self.assertEqual(categorize.determine_character(weapon_name='Choora'), 'Toan')
